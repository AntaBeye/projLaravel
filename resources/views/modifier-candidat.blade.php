...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
   ...
   <!-- modifier-candidat.blade.php -->
    ...
    <form action="{{ route('sauvegarderModificationCandidat', ['id' => $candidat->id]) }}" method="POST">
        @csrf

        <div class="form-group">
            <label for="name">Nom Candidat</label>
            <input type="text" class="form-control" id="name" name="name" value="{{ $candidat->name }}">
        </div>

        <div class="form-group">
            <label for="parti">Parti Politique</label>
            <input type="text" class="form-control" id="parti" name="parti" value="{{ $candidat->parti }}">
        </div>

        <div class="form-group">
            <label for="programme_politique">Programme Politique</label>
            <textarea class="form-control" id="programme_politique" name="programme_politique" rows="3">{{ $candidat->programme_politique }}</textarea>
        </div>

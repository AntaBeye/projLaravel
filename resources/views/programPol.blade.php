...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <h1>LES PROGRAMMES POLITIQUES</h1>
    ...
    <table class="table" style="width: 75%; margin: 0 auto;" >
        ...
        <tbody>
          ...
          <td>
            <a href="{{ route('modifierCandidat', ['id' => $candidat->id]) }}" class="btn btn-success">Modifier</a>
            <a href="{{ route('supprimerCandidat', ['id' => $candidat->id]) }}" class="btn btn-danger">Supprimer</a>
          </td>
            <td class="text-center">
              @php
                $totalRating = 0;
            @endphp
            @foreach ($nombreAvisParProgramme as $avis)
                @if ($avis->programme_politique_id == $candidat->id) <!-- Comparaison avec l'id du candidat -->
                    @php
                        $totalRating = $avis->total_rating;
                    @endphp
                    @break
                @endif
            @endforeach
           ...
           <td> <a href="/adminSondage" class="btn btn-info">Voir</a></td>

          </tr>
          @endforeach
        </tbody>
      </table>
<!-- La vue où vous souhaitez afficher le bouton pour ajouter un candidat -->

<a href="{{ route('afficherFormulaireAjout') }}" class="btn btn-primary">Ajouter Candidat</a>
